...
export default function CommentSection({ ticketId }: { ticketId: string }) {
    ...
    return (
        <Card className="flex flex-col h-[500px] overflow-hidden border-none shadow-none bg-transparent">
            ...
            <CardContent className="flex-1 flex flex-col p-0 gap-4">
                ...
                <div
                    ref={scrollRef}
                    className="flex-1 overflow-y-auto space-y-6 pr-4 -mr-4 pl-1"
                >
                    {comments.length === 0 ? (
                        ...
                        comments.map((comment) => (
                            <div key={comment._id} className="flex gap-4 group">
                                ...
                                <div className="flex-1 gap-1">
                                    ...
                                    <div className="text-sm text-foreground/90 leading-relaxed bg-muted/50 p-3 rounded-r-lg rounded-bl-lg">
                                        {comment.content}
                                    </div>
                                </div>
                            </div>
                    ...
                    <form onSubmit={handleSubmit} className="relative flex gap-3 items-end">
                        ...
                        <div className="flex-1 relative">
                            <Textarea
                                ...
                                className="min-h-[44px] max-h-[150px] py-3 pr-12 resize-none bg-muted/30 focus:bg-background transition-colors rounded-2xl"
                                onKeyDown={(e) => {
